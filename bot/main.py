...
async def main():
    try:
        # ✅ ВАЖНО: грузим .env (Codespace/локально)
        # Render просто проигнорит, потому что там .env обычно нет
        load_dotenv()
        ...
        if missing:
            ...
            print("✅ Fix:")
            print("1) create .env in project root with:")
            print("   BOT_TOKEN=...")
            print("   CHANNEL_ID=-100...")
            print("   ADMIN_IDS=123,456")
        ...
        try:
            ...
            raise RuntimeError("CHANNEL_ID must be int like -1001234567890")

        admin_ids = parse_admin_ids(admin_ids_raw)
        if not admin_ids:
            raise RuntimeError("ADMIN_IDS is empty/invalid. Example: 6223307792,123456")

        print("✅ ENV OK")
        print("   CHANNEL_ID:", channel_id)
        print("   ADMINS:", sorted(admin_ids))
        print("   DB:", db_path)
